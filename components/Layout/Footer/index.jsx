...
const Component = () => {
  ...
  return (
    <FooterBox>
      ...
      <MadeWith>
        Made with{' '}
        <a href={`https://nextjs.org/${utm}`} target="_blank" rel="noreferrer noopener" title="Nextjs">
          Nextjs
        </a>{' '}
        and{' '}
        <a href={`https://reactjs.org/${utm}`} target="_blank" rel="noreferrer noopener" title="React">
          React
        </a>
      </MadeWith>
    </FooterBox>
